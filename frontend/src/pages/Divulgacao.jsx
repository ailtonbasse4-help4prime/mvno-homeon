        ...
        <div className="space-y-6">
          <div className="dashboard-card p-6" data-testid="divulgacao-link-section">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1 bg-zinc-950 border border-zinc-800 rounded-lg px-4 py-3 font-mono text-sm text-blue-400 truncate" data-testid="divulgacao-portal-url">
                {portalUrl}
              </div>
              <Button
                onClick={handleCopy}
          ...
          <div className="dashboard-card p-6">
            ...
            <div className="bg-zinc-950 border border-zinc-800 rounded-lg p-4 text-sm text-zinc-300 whitespace-pre-line">
